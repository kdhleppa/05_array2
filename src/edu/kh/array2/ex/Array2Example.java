...
public class Array2Example {
	...
	public void ex1() {
		...
		*/
		...
		// Arrays.deepToString(배열명_
		// - 참조하고 있는 배열의 데이터가 나오는 부분까지 파고 들어가서
		// 모든 값을 문자열로 반환
		System.out.println("deepT oString() : " + Arrays.deepToString(arr));
	...
	public void ex3() {
		...
		arr[3] = new char[2]; // 3행\에 2열짜리 1차원 배열을 생성하여 주소값 저장
